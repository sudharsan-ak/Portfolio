...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="Resume.php"><strong>RESUMES</strong></a></li>
            ...
            <li><a href="Home.php"><strong>LOG OUT</strong></a></li>
    ...
    <div class="main_content">
      ...
      <a href="Resume.pdf" download><button class="btn" type="submit" style="width:15%">Download my CV </button><br></a>  
      <img src="images/mouse.jpg" alt="mouse" style="margin-left: 500px; width: 50px; height: 50px;">
    </div>
